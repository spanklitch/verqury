...
- **Status:** In development — pre-0.1 (Phases 0–3 of the [build plan](verqury-build-plan.md) complete: data layer, CLI, Electron shell with live project views, and the guidance library; see [CHANGELOG](CHANGELOG.md))
