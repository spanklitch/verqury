...
- **Status:** In development — pre-0.1 (Phases 0–7 of the [build plan](verqury-build-plan.md) complete: data layer, CLI, Electron shell with live project views, the guidance library, the artifact inbox with clipboard capture, the session bootstrapper, the task router, and the adapter registry; only packaging remains; see [CHANGELOG](CHANGELOG.md))
