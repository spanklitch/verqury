...
- **Status:** **v0.1.1 released** (2026-07-08) — all nine build-plan phases complete; dark-navy UI, drag-and-drop capture, packages as an AppImage + `.deb`. See [CHANGELOG](CHANGELOG.md).
