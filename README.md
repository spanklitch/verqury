...
- **Status:** In development — pre-0.1 (Phases 0–2 of the [build plan](verqury-build-plan.md) complete: data layer, CLI, and Electron shell with live project views; see [CHANGELOG](CHANGELOG.md))
