...
- **Status:** In development — pre-0.1 (Phases 0–4 of the [build plan](verqury-build-plan.md) complete: data layer, CLI, Electron shell with live project views, the guidance library, and the artifact inbox with clipboard capture; see [CHANGELOG](CHANGELOG.md))
