...
| [0016](0016-closing-the-window-quits.md) | Closing the window quits (reverses tray residency) | Accepted |
| [0017](0017-a-card-that-cannot-be-sent-parks-at-the-desk.md) | A card that cannot be sent parks at the desk immediately | Accepted |
